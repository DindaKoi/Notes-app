...
function isStorageExist() {
  if (typeof (Storage) === undefined) {
    alert('Browser kamu tidak mendukung local storage nih:(');
    return false;
  }
  return true;
}
...
document.addEventListener(RENDER_EVENT, function () {
  ...
  if (todos.length === 0) {
    uncompletedTODOList.innerHTML = '<p>Tidak ada tugas yang belum selesai</p>';
    listCompleted.innerHTML = '<p>Tidak ada tugas yang selesai</p>';
  }
